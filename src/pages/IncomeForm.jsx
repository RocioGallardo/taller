...
function IncomeForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      console.error(err)
      setError('No pudimos guardar el ingreso. Intentalo de nuevo.')
    } finally {
      setSubmitting(false)
    }
  }
    ...
    <div className="incomes-page">
      <header className="page-header">
        <div>
          ...
          <p>Registrá los cobros realizados por clientes u otros ingresos.</p>
        </div>
        ...
        <form className="form-grid" onSubmit={handleSubmit} onReset={handleReset}>
          ...
          <div className="form-field">
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Ej: Cobro reparación, adelanto, etc."
              required
            />
          </div>
          ...
          <div className="form-field">
            ...
            <small>
              Seleccioná un cliente para filtrar las órdenes disponibles y completar
              automáticamente la información del ingreso.
            </small>
          </div>
